...
col_headers_ythdf3 <- c("GSM3944607", "GSM3944608", "GSM3944615", "GSM3944616", "GSM3944617")
control_ythdf3 <- c("control", "control", "notcontrol", "notcontrol", "notcontrol")

col_headers_setd2 <- c("GSM3450419", "GSM3450420", "GSM3450423", "GSM3450424")
control_setd2 <- c("control", "control", "notcontrol", "notcontrol")
...
col_headers_kbtbd8 <- c("GSM1782874", "GSM1782875", "GSM1782876", "GSM1782878", "GSM1782879")
control_kbtbd8 <- c("control", "control", "notcontrol", "control", "notcontrol")

col_headers_tcof1 <- c("GSM1782874", "GSM1782875", "GSM1782877", "GSM1782878", "GSM1782880")
control_tcof1 <- c("control", "control", "notcontrol", "control", "notcontrol")

col_headers_fbl <- c("GSM2825128", "GSM2825129", "GSM2825131", "GSM2825132")
control_fbl <- c("control", "notcontrol", "notcontrol", "control")

col_headers_ythdf1 <- c("GSM3944607", "GSM3944608", "GSM3944609", "GSM3944610", "GSM3944611")
control_ythdf1 <- c("control", "control", "notcontrol", "notcontrol", "notcontrol")

col_headers_ythdf2 <- c("GSM3944607", "GSM3944608", "GSM3944613", "GSM3944614")
control_ythdf2 <- c("control", "control", "notcontrol", "notcontrol")
